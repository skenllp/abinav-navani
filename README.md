# Abinav & Navani — Wedding Invitation

Mobile-first cinematic invitation. Plain HTML5, CSS3, and vanilla JavaScript.

- **Live Site**: [https://abinav-navani.vercel.app/](https://abinav-navani.vercel.app/)
- **Repository**: [https://github.com/skenllp/abinav-navani.git](https://github.com/skenllp/abinav-navani.git)
